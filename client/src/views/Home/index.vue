<template>
  <div class="Home">
    ...
    <div  class="end">
      <div  class="bottom">
        <p>Copyright © 2018-2021 QT All Rights Reserved</p>
        <a  target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=21120202000172">
        <img  src="../../assets/img/police.png" style="margin-left: 15px; height: 20px;width:20px;">
        </a>
        <a  target="_blank" href="https://beian.miit.gov.cn/" rel="external nofollow" class="iconfont iconbeian">黔ICP备2020010956号-1</a>
        </div>
        </div>
  </div>
</template>
...
<style lang="less" scoped>
  .Home{
    ...
    .end{
        position: relative;
        z-index: 9;
        background-color: rgba(30,30,42,.616);
        .bottom{
            padding: 10px 0;
            text-align: center;
            font-size: 13px;
